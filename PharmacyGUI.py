...
def addmed():
    ...
    con = mysql.connect(
        host="localhost",
        user="root",
        password="Aditya@0707",
        database="dbms_medicine"
    )

    cursor = con.cursor()
    cursor.execute("DELETE FROM medicine WHERE medicine_id='1003'")
    cursor.execute("INSERT INTO medicine VALUES ('"+med_id_adder.get()+"', '" +
                   med_name_adder.get()+"', '"+med_cost_adder.get()+"', '"+med_brand_adder.get()+"')")
    con.commit()
    con.close()
...
def addlogin():
    ...
    cursor = con.cursor()
    print("INSERT INTO login VALUES ('"+login_id_adder.get()+"', '" +
          login_username_adder.get()+"', '"+login_password_adder.get()+"')")
    cursor.execute("INSERT INTO login VALUES ('"+login_id_adder.get()+"', '" +
                   login_username_adder.get()+"', '"+login_password_adder.get()+"')")
    cursor.execute("INSERT INTO role VALUES ('"+role_id_adder.get() +
                   "','"+role_type_adder.get()+"', '"+login_id_adder.get()+"')")
    con.commit()
    con.close()
...
def addbatch():
    ...
    cursor = con.cursor()
    print("INSERT INTO batch VALUES ('"+batch_no_adder.get()+"', '"+batch_med_stock_adder.get() +
          "', '"+batch_mfg_adder.get()+"', '"+batch_expdate_adder.get()+"', '"+batch_med_id_adder.get()+"'")
    cursor.execute("INSERT INTO batch VALUES ('"+batch_no_adder.get()+"', '"+batch_med_stock_adder.get() +
                   "', '"+batch_mfg_adder.get()+"', '"+batch_expdate_adder.get()+"', '"+batch_med_id_adder.get()+"')")
    con.commit()
    con.close()
...
def addorg():
    ...
    cursor = con.cursor()
    cursor.execute("INSERT INTO organisation VALUES ('"+org_id_adder.get()+"', '" +
                   org_name_adder.get()+"', '"+org_type_adder.get()+"', '"+org_contact_adder.get()+"')")
    con.commit()
    con.close()
...
def adduser():
    ...
    cursor = con.cursor()
    cursor.execute("INSERT INTO user VALUES ('"+username_adder.get()+"', '"+user_phone_adder.get()+"', '"+user_email_adder.get() +
                   "', '"+user_street_adder.get()+"', '"+user_city_adder.get()+"', '"+user_state_adder.get()+"', '"+user_pincode_adder.get()+"')")
    con.commit()
    con.close()
...
def addsaledetails():
    ...
    cursor = con.cursor()
    cursor.execute("INSERT INTO sale_details VALUES ('"+sale_date_adder.get()+"', '"+sale_id_adder.get()+"', '"+sale_user_id_adder.get() +
                   "', '"+sale_org_id_adder.get()+"', '"+user_city_adder.get()+"', '"+user_state_adder.get()+"', '"+user_pincode_adder.get()+"')")
    con.commit()
    con.close()
...
def addsale():
    ...
    cursor = con.cursor()
    cursor.execute("INSERT INTO sale_details VALUES ('"+sale_id_adder.get()+"', '"+sale_med_id_adder.get()+"', '"+sale_med_cost_adder.get() +
                   "', '"+sale_batch_id_adder.get()+"', '"+sale_quantity_adder.get()+"', '"+sale_quantity_adder*sale_med_cost_adder.get()+"')")
    con.commit()
    con.close()
    sale_id_adder.delete(0, END)
...
def updatemed():
    ...
    cursor = con.cursor()
    cursor.execute("UPDATE medicine SET MEDICINE_NAME='"+med_name_updater.get()+"', medicine_cost='"+med_cost_updater.get() +
                   "', medicine_brand= '"+med_brand_updater.get()+"' where medicine_id='"+med_id_updater.get()+"'")
    con.commit()
    con.close()
...
def updatelogin():
    ...
    batch_no_updater.config(state=DISABLED)
    cursor = con.cursor()
    cursor.execute("UPDATE login SET  login_username='"+login_username_updater.get() +
                   "', login_password= '"+login_password_updater.get()+"' where login_id='"+login_id_updater.get()+"'")
    cursor.execute("UPDATE role SET  role_type='"+role_id_updater.get()+"', role_user_id= '" +
                   login_id_updater.get()+"' where role_id='"+role_id_updater.get()+"'")
...
def updatebatch():
    ...
    batch_no_updater.config(state=DISABLED)
    cursor = con.cursor()
    cursor.execute("UPDATE batch SET MEDICINE_STOCK='"+batch_med_stock_updater.get()+"', MANUFACTURE_DATE='"+batch_mfg_updater.get() +
                   "', EXPIRY_DATE= '"+batch_expdate_updater.get()+"', MED_ID='"+batch_med_id_updater.get()+"' where BATCH_NO='"+batch_no_updater.get()+"'")
    con.commit()
    con.close()
...
def updateorg():
    ...
    cursor = con.cursor()
    cursor.execute("UPDATE organisation SET org_name='"+org_name_updater.get()+"', org_type='"+org_type_updater.get() +
                   "', contact_no= '"+org_contact_updater.get()+"' where org_id='"+org_id_updater.get()+"'")
    con.commit()
    con.close()
...
def updatesaledetails():
    ...
    cursor = con.cursor()
    cursor.execute("UPDATE sale_details SET org_id='"+sale_org_id_updater.get() +
                   "', user_id='"+sale_user_id_updater.get()+"'where sale_id='"+sale_id_updater.get()+"'")
    con.commit()
    con.close()
...
def updatesale():
    ...
    cursor = con.cursor()
    cursor.execute("UPDATE sales SET medicine_cost='"+sale_med_cost_updater.get()+"', medicine_id='"+sale_med_id_updater.get()+"', batch_id='"+sale_batch_id_updater.get() +
                   "', quantity='"+sale_quantity_updater.get()+"', amount='"+sale_quantity_updater.get()*sale_med_cost_updater+"' where sale_id='"+sale_id_updater.get()+"'")
    con.commit()
    con.close()
...
def updateuser():
    ...
    cursor = con.cursor()
    cursor.execute("UPDATE user_info SET phone_number='"+user_phone_updater.get()+"', email='"+user_email_updater.get()+"', street_user='"+user_street_updater.get() +
                   "', user_city='"+user_city_updater.get()+"', user_state='"+user_state_updater.get()+"', pincode='"+user_pincode_updater.get()+"'where username='"+username_updater.get()+"'")
    con.commit()
    con.close()
...
def add():
    ...
    med_name_label_adder = Label(
        adder, text='Enter med_name', font=('bold', 10))
    med_name_label_adder.grid(row=i+1, column=0)
    med_cost_label_adder = Label(
        adder, text='Enter med_cost', font=('bold', 10))
    med_cost_label_adder.grid(row=i+2, column=0)
    med_brand_label_adder = Label(
        adder, text='Enter med_brand', font=('bold', 10))
    ...
    login_id_label_adder = Label(
        adder, text='Enter login_id', font=('bold', 10))
    login_id_label_adder.grid(row=i, column=3)
    login_username_label_adder = Label(
        adder, text='Enter login_username', font=('bold', 10))
    login_username_label_adder.grid(row=i+1, column=3)
    login_password_label_adder = Label(
        adder, text='Enter login_password', font=('bold', 10))
    ...
    role_type_label_adder = Label(
        adder, text='Enter role_type', font=('bold', 10))
    ...
    i = 7
    batch_no_label_adder = Label(
        adder, text='Enter batch_no', font=('bold', 10))
    batch_no_label_adder.grid(row=i, column=0, pady=(10, 0))
    batch_med_stock_label_adder = Label(
        adder, text='Enter batch_med_stock', font=('bold', 10))
    batch_med_stock_label_adder.grid(row=i+1, column=0)
    batch_mfg_label_adder = Label(
        adder, text='Enter batch_mfg', font=('bold', 10))
    batch_mfg_label_adder.grid(row=i+2, column=0)
    batch_expdate_label_adder = Label(
        adder, text='Enter batch_expdate', font=('bold', 10))
    batch_expdate_label_adder.grid(row=i+3, column=0)
    batch_med_id_label_adder = Label(
        adder, text='Enter Med_id', font=('bold', 10))
    ...
    org_name_label_adder = Label(
        adder, text='Enter org_name', font=('bold', 10))
    org_name_label_adder.grid(row=i+1, column=0)
    org_type_label_adder = Label(
        adder, text='Enter org_type', font=('bold', 10))
    org_type_label_adder.grid(row=i+2, column=0)
    org_contact_label_adder = Label(
        adder, text='Enter org_contact', font=('bold', 10))
    ...
    i = 21
    sale_date_label_adder = Label(
        adder, text='Enter sale_date', font=('bold', 10))
    ...
    sale_user_id_label_adder = Label(
        adder, text='Enter sale_user_id', font=('bold', 10))
    sale_user_id_label_adder.grid(row=i+2, column=0)
    sale_org_id_label_adder = Label(
        adder, text='Enter sale_org_id', font=('bold', 10))
    ...
    addsaledet1 = Button(
        adder, text="Add sale details Data", command=addsaledetails)
    addsaledet1.grid(row=i+6, column=0, pady=(10, 0))

    # sales
    sale_med_id_label_adder = Label(
        adder, text='Enter sale_med_id', font=('bold', 10))
    sale_med_id_label_adder.grid(row=i, column=3, pady=(10, 0))
    sale_med_cost_label_adder = Label(
        adder, text='Enter sale_med_cost', font=('bold', 10))
    sale_med_cost_label_adder.grid(row=i+1, column=3)
    sale_batch_id_label_adder = Label(
        adder, text='Enter sale_batch_id', font=('bold', 10))
    sale_batch_id_label_adder.grid(row=i+2, column=3)
    sale_quantity_label_adder = Label(
        adder, text='Enter sale_quantity', font=('bold', 10))
    sale_quantity_label_adder.grid(row=i+3, column=3)
    sale_amount_label_adder = Label(
        adder, text='Sale Amount', font=('bold', 10))
    ...
    i = 28
    username_label_adder = Label(
        adder, text='Enter username', font=('bold', 10))
    username_label_adder.grid(row=i, column=0, pady=(10, 0))
    user_phone_label_adder = Label(
        adder, text='Enter user_phone', font=('bold', 10))
    user_phone_label_adder.grid(row=i+1, column=0)
    user_email_label_adder = Label(
        adder, text='Enter user_email', font=('bold', 10))
    user_email_label_adder.grid(row=i+2, column=0)
    user_street_label_adder = Label(
        adder, text='Enter user_street', font=('bold', 10))
    user_street_label_adder.grid(row=i+3, column=0)
    user_city_label_adder = Label(
        adder, text='Enter user_city', font=('bold', 10))
    user_city_label_adder.grid(row=i+4, column=0)
    user_state_label_adder = Label(
        adder, text='Enter user_state', font=('bold', 10))
    user_state_label_adder.grid(row=i+5, column=0)
    user_pincode_label_adder = Label(
        adder, text='Enter user_pincode', font=('bold', 10))
...
def updater():
    ...
    v.grid(sticky=E, row = 0, rowspan =10, column = 20, ipady = 1000)'''
    i = 0
    med_id_label_updater = Label(
        updater, text='Enter med_id', font=('bold', 10))
    med_id_label_updater.grid(row=i, column=0)
    med_name_label_updater = Label(
        updater, text='Enter med_name', font=('bold', 10))
    med_name_label_updater.grid(row=i+1, column=0)
    med_cost_label_updater = Label(
        updater, text='Enter med_cost', font=('bold', 10))
    med_cost_label_updater.grid(row=i+2, column=0)
    med_brand_label_updater = Label(
        updater, text='Enter med_brand', font=('bold', 10))
    ...
    updatemed1 = Button(
        updater, text="Update Medicine Data", command=updatemed)
    updatemed1.grid(row=i+6, column=0)

    login_id_label_updater = Label(
        updater, text='Enter login_id', font=('bold', 10))
    login_id_label_updater.grid(row=i, column=3)
    login_username_label_updater = Label(
        updater, text='Enter login_username', font=('bold', 10))
    login_username_label_updater.grid(row=i+1, column=3)
    login_password_label_updater = Label(
        updater, text='Enter login_password', font=('bold', 10))
    login_password_label_updater.grid(row=i+2, column=3)
    role_id_label_updater = Label(
        updater, text='Enter role_id', font=('bold', 10))
    role_id_label_updater.grid(row=i+3, column=3)
    role_type_label_updater = Label(
        updater, text='Enter role_type', font=('bold', 10))
    ...
    updatelogin1 = Button(
        updater, text="Update login Data", command=updatelogin)
    updatelogin1.grid(row=i+6, column=4, pady=(10, 0))

    i = 7
    batch_no_label_updater = Label(
        updater, text='Enter batch_no', font=('bold', 10))
    batch_no_label_updater.grid(row=i, column=0, pady=(10, 0))
    batch_med_stock_label_updater = Label(
        updater, text='Enter batch_med_stock', font=('bold', 10))
    batch_med_stock_label_updater.grid(row=i+1, column=0)
    batch_mfg_label_updater = Label(
        updater, text='Enter batch_mfg', font=('bold', 10))
    batch_mfg_label_updater.grid(row=i+2, column=0)
    batch_expdate_label_updater = Label(
        updater, text='Enter batch_expdate', font=('bold', 10))
    batch_expdate_label_updater.grid(row=i+3, column=0)
    batch_med_id_label_updater = Label(
        updater, text='Enter Med_id', font=('bold', 10))
    ...
    updatebatch1 = Button(
        updater, text="Update Batch Data", command=updatebatch)
    updatebatch1.grid(row=i+6, column=0, pady=(10, 0))

    i = 15
    org_id_label_updater = Label(
        updater, text='Enter org_id', font=('bold', 10))
    org_id_label_updater.grid(row=i, column=0, pady=(10, 0))
    org_name_label_updater = Label(
        updater, text='Enter org_name', font=('bold', 10))
    org_name_label_updater.grid(row=i+1, column=0)
    org_type_label_updater = Label(
        updater, text='Enter org_type', font=('bold', 10))
    org_type_label_updater.grid(row=i+2, column=0)
    org_contact_label_updater = Label(
        updater, text='Enter org_contact', font=('bold', 10))
    ...
    check.grid(row=15,column=2)'''
    i = 21
    sale_date_label_updater = Label(
        updater, text='Enter sale_date', font=('bold', 10))
    sale_date_label_updater.grid(row=i, column=0, pady=(10, 0))
    sale_id_label_updater = Label(
        updater, text='Enter sale_id', font=('bold', 10))
    sale_id_label_updater.grid(row=i+1, column=0)
    sale_user_id_label_updater = Label(
        updater, text='Enter sale_user_id', font=('bold', 10))
    sale_user_id_label_updater.grid(row=i+2, column=0)
    sale_org_id_label_updater = Label(
        updater, text='Enter sale_org_id', font=('bold', 10))
    ...
    updatesaledet1 = Button(
        updater, text="Update sale details Data", command=updatesaledetails)
    updatesaledet1.grid(row=i+6, column=0, pady=(10, 0))

    # sales
    sale_med_id_label_updater = Label(
        updater, text='Enter sale_med_id', font=('bold', 10))
    sale_med_id_label_updater.grid(row=i, column=3, pady=(10, 0))
    sale_med_cost_label_updater = Label(
        updater, text='Enter sale_med_cost', font=('bold', 10))
    sale_med_cost_label_updater.grid(row=i+1, column=3)
    sale_batch_id_label_updater = Label(
        updater, text='Enter sale_batch_id', font=('bold', 10))
    sale_batch_id_label_updater.grid(row=i+2, column=3)
    sale_quantity_label_updater = Label(
        updater, text='Enter sale_quantity', font=('bold', 10))
    sale_quantity_label_updater.grid(row=i+3, column=3)
    sale_amount_label_updater = Label(
        updater, text='Sale Amount', font=('bold', 10))
    ...
    i = 28
    username_label_updater = Label(
        updater, text='Enter username', font=('bold', 10))
    username_label_updater.grid(row=i, column=0, pady=(10, 0))
    user_phone_label_updater = Label(
        updater, text='Enter user_phone', font=('bold', 10))
    user_phone_label_updater.grid(row=i+1, column=0)
    user_email_label_updater = Label(
        updater, text='Enter user_email', font=('bold', 10))
    user_email_label_updater.grid(row=i+2, column=0)
    user_street_label_updater = Label(
        updater, text='Enter user_street', font=('bold', 10))
    user_street_label_updater.grid(row=i+3, column=0)
    user_city_label_updater = Label(
        updater, text='Enter user_city', font=('bold', 10))
    user_city_label_updater.grid(row=i+4, column=0)
    user_state_label_updater = Label(
        updater, text='Enter user_state', font=('bold', 10))
    user_state_label_updater.grid(row=i+5, column=0)
    user_pincode_label_updater = Label(
        updater, text='Enter user_pincode', font=('bold', 10))
    ...
    cursor = con.cursor()
    cursor.execute(
        "SELECT * FROM medicine WHERE medicine_id='" + med_id.get()+"'")
    ...
    cursor.execute(
        "SELECT * FROM organisation WHERE org_id='" + org_id.get()+"'")
    ...
    cursor.execute(
        "SELECT * FROM sale_details WHERE sale_id='" + sale_id.get()+"'")
    ...
    cursor.execute("SELECT * FROM user_info WHERE username='" +
                   username.get()+"'")
...
def deli():
    ...
    if(tabn == "batch"):
        ...
        colname = "username"
    cursor.execute("DELETE FROM `dbms_medicine`.`"+tabn +
                   "` WHERE (`"+colname+"` = '"+var+"');")
...
def delete():
    ...
    global delid1
    col = ["batch", "login", "medicine", "organisation",
           "role", "sale_details", "sales", "user_info"]
    global tab
    tab = StringVar()
    tab.set("batch")
...
def submit_sale():
    ...
    con = mysql.connect(host="localhost", user="root",
                        password="Aditya@0707", database="dbms_medicine")
    cursor = con.cursor()
    if(tab.get() == "Sale id"):
        cursor.execute(
            "select sale_date from sale_details where sale_id =\'"+sid+"\';")
    ...
    list.pack()
    list.insert(
        END, "sale date  medicine id   medicine name  batch id   quantity   medicine cost   amount")
    sum = 0
    for row in bill:
        sum = sum+row[6]
        insert = str(row[0])+'                 '+str(row[1])+'             '+str(row[2])+'          '+str(row[3]) + \
            '            '+str(row[4])+'                        ' + \
            str(row[5])+'                    '+str(row[6])
...
def Med():
    ...
    medlb = Label(
        top, text='Enter Medicine details for which you want details for')
...
def manager():
    ...
    Back1 = Button(manager, text="Signout", command=lambda: [
                   manager.destroy(), mainpage()]).pack()
...
def employee():
    ...
    Back2 = Button(employee, text="Signout", command=lambda: [
                   employee.destroy(), mainpage()]).pack()
    print("in")
    cursor = con.cursor()
    con.close()
    employee.mainloop()
...
def submit():
    ...
    if(username.get() == "" or password.get() == ""):
        ...
        cursor = con.cursor()
        cursor.execute(
            "SELECT EXISTS(SELECT * from login WHERE Login_username='"+username.get()+"');")
        result1 = cursor.fetchall()
        # print(result1[0])
        if(result1[0][0] == 0):
            denied()
        cursor.execute(
            "select login_password,role_type from login inner join role on role_user_id=login_id where Login_username=\'"+username.get()+"\'")
...
def login():
    ...
    Back = Button(login, text="back to Mainpage", command=lambda: [
                  login.destroy(), mainpage()]).pack()
...
def mainpage():
    ...
    main2 = Label(main, text="Welcome to PHARMACY-DBMS",
                  font=('Times New Roman', 15, 'bold'))
    main2.pack()
    main1 = Label(main, text="Please Enter the Login Credentials",

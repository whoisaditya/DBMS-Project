...
INSERT INTO `dbms_medicine`.`login` (`Login_id`, `Login_username`, `Login_password`) VALUES ('L101', 'Aditya', 'aditya.mitra');
INSERT INTO `dbms_medicine`.`login` (`Login_id`, `Login_username`, `Login_password`) VALUES ('L102', 'Ritu', 'ritu.raj');
INSERT INTO `dbms_medicine`.`login` (`Login_id`, `Login_username`, `Login_password`) VALUES ('L103', 'Sanjna', 'sanjna.sub');
